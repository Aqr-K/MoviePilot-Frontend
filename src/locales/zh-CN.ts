export default {
  ...
  theme: {
    ...
    glassUIStyle: '界面风格',
    glassUIStyleAdaptive: '自适应',
    glassUIStyleClear: '通透',
    glassUIStyleHint: '同时应用到顶栏、底部悬浮导航栏、弹出菜单、弹出窗口和 FAB 悬浮按钮。',
    glassQuality: '质量',
    glassQualityCss: '标准',
  ...
  music: {
    ...
    discographyDescription: '按官方作品集查看媒体库与站点资源，已入库作品默认不选中。',
    discographyLoadFailed: '加载艺术家作品失败',
    artistCollectionResources: '艺术家合集资源',
    artistCollectionDescription:
      '按艺术家搜索大合集种子；一份资源可覆盖多张官方作品，下载源目录统一归入 Artist Collection。',
    downloadArtistCollection: '下载大合集',
    downloadArtistCollectionConfirm: '确定使用默认下载器下载“{title}”吗？',
    artistCollectionDownloadAdded: '艺术家合集已加入下载',
    estimatedCoverage: '预计覆盖 {count}/{total} 个官方作品',
    coverageUnknown: '覆盖范围需查看资源详情',
    unknownSite: '未知站点',
    seeders: '{count} 做种',
    officialWorks: '官方作品',
    statusInLibrary: '已入库',
    notInLibrary: '未入库',
    selectDownloadable: '选中可下载',
    batchDownload: '批量下载',
    batchDownloadConfirm: '确定使用默认下载器下载选中的 {count} 个作品吗？',
    batchDownloadResult: '批量下载已处理：{success}/{total} 个成功',
    newestFirst: '最新优先',
    oldestFirst: '最早优先',
    rematchResources: '重新匹配',
    noOfficialWorks: '没有找到可显示的官方作品',
    selectAlbum: '选择专辑 {title}',
    unknownReleaseDate: '发行日期未知',
  ...
  agentAssistant: {
    ...
    steeringPlaceholder: '任务运行中，可补充消息...',
    steeringQueued: '已排队',
    steeringApplied: '已加入上下文',
  ...
  subscribe: {
    ...
    execution: {
      details: '搜索详情',
      autoResume: '站点暂时繁忙，系统会自动继续搜索，无需重复操作。',
      taskResume: '当前任务结束后，系统会自动继续搜索，无需重复操作。',
      resumeAt: '预计 {time} 自动继续（本地时间）',
      resumeDue: '已到预计时间，正在等待自动继续。',
      failedHint: '本次搜索未完成，可重新搜索；若持续出现，请检查站点。',
      failureDetails: '查看失败详情',
      retry: '重新搜索',
      checkSites: '检查站点',
      searchSubmitted: '{name} 已安排搜索',
      searchScheduled: '{name} 已安排搜索，很快开始',
      searchAlreadyRunning: '{name} 已经在搜索中，请稍候',
    ...
    maintenance: {
      title: '订阅维护',
      searchAll: '搜索当前媒体类型订阅',
      searchAllConfirmTitle: '确认搜索当前媒体类型订阅',
      searchAllConfirm:
        '系统会依次搜索当前账号可访问的当前媒体类型订阅，并访问相应站点。订阅较多时需要一些时间，是否继续？',
      searchAllStarted: '当前媒体类型订阅搜索已安排！',
      searchAllEmpty: '当前媒体类型没有需要搜索的订阅',
      searchAllAlreadyRunning: '{count} 个当前媒体类型订阅已经在搜索中，请稍候',
      searchAllMixed: '已安排 {queued} 个当前媒体类型订阅搜索，另有 {ongoing} 个正在处理中',
      searchAllScheduled: '已安排 {count} 个当前媒体类型订阅，系统会自动依次搜索',
      refresh: '刷新订阅资源',
  ...
  setting: {
    classification: {
      title: '媒体自动分类',
      description: '将符合条件的媒体自动归入对应目录。请依次完成以下 3 个步骤。',
      workspaceCategories: '1. 设置目录',
      workspaceRules: '2. 设置规则',
      workspaceReview: '3. 测试并保存',
      quickGuideEyebrow: '设置流程',
      quickGuideTitle: '自动分类设置流程',
      quickGuideHint: '请先配置存放目录，再设置匹配规则，最后预览分类结果并保存。',
      quickGuideAria: '自动分类设置步骤',
      quickGuideSteps: {
        categories: { title: '设置目录', hint: '配置媒体存放目录' },
        rules: { title: '设置规则', hint: '配置媒体匹配条件' },
        review: { title: '测试并保存', hint: '验证分类结果并应用' },
      },
      ...
      restoreDefaults: '恢复内置默认规则',
      restoreDefaultsConfirm: '将用内置默认分类规则替换当前草稿，尚未发布的修改会被覆盖。确定继续吗？',
      defaultsLoaded: '已恢复内置默认分类规则，请校验后发布',
      defaultsLoadFailed: '内置默认分类规则加载失败',
      enrichmentTitle: '分类信息来源',
      enrichmentSimpleTitle: '补充信息（可选）',
      enrichmentSimpleHint: '通常无需调整。仅当规则所需信息未由主要数据源提供时，系统才会尝试补充。',
      enrichmentSimpleNote: '当前使用默认设置：仅在必要时补充缺失信息，不会改变媒体的主要来源。',
      enrichmentHint:
      ...
      analysisHint: '发布前可查看分类匹配结果、变更影响并确认历史版本。',
      simpleReviewTitle: '验证分类结果并保存',
      simpleReviewHint: '搜索并选择一条媒体，确认分类结果。校验通过后，点击“确认并应用”。',
      simpleReviewCheck: '检查当前规则',
      simpleReviewApply: '确认并应用',
      simpleReviewImpact: '已检查 {sample} 条近期记录：{changed} 条分类将发生变化，{degraded} 条结果可能降级。',
      previewTab: '结果预览',
      impactTab: '影响分析',
      publishTab: '发布与历史',
      previewFailed: '分类预览请求失败',
      impactFailed: '分类影响分析失败',
      publishSucceeded: '分类规则已发布为第 {revision} 版',
      publishFailed: '分类策略发布失败',
      remoteReloaded: '已重新加载服务端活动策略',
      remoteReloadFailed: '重新加载服务端策略失败',
      historyFailed: '分类策略历史加载失败',
      rollbackSucceeded: '第 {source} 版已恢复，并发布为第 {revision} 版',
      rollbackFailed: '分类策略回退失败',
      directoryReferencesUnavailable: '目录引用加载失败',
      directoryReferencesUnavailableHint: '当前无法展示完整目录引用保护；服务端仍会在校验和发布时阻止无效变更。',
      helpButton: '查看自动分类帮助',
      helpTitle: '自动分类使用说明',
      helpDescription: '请按顺序完成配置、校验和发布。',
      helpClose: '知道了',
      help: {
        sections: {
          categories: {
      ...
      category: {
        title: '存放目录',
        description:
          '配置媒体分类目录。规则命中后，媒体将归入对应目录；未命中时使用默认目录。路径最多支持 {count} 级。',
        add: '新增{mediaType}分类',
        ...
        fallbackTitle: '未匹配媒体的默认分类',
        fallbackHint: '当所有分类规则均未命中时，媒体将归入所选分类。该分类与规则中的“归入分类”共用同一分类列表。',
        fallbackFor: '{mediaType}默认分类',
        fallbackBadge: '默认分类',
        legacyHint: '该分类为旧版迁移时创建的备用目录，仅在被规则、默认分类或目录设置引用时使用。',
        pathRequired: '分类路径不能为空',
        pathEmptySegment: '分类路径不能包含空层级',
        pathTooDeep: '分类路径最多支持 {count} 级',
        duplicatePath: '同一媒体类型下不能使用重复分类路径',
        pathSegmentTooLong: '分类路径单段不能超过 {count} 个字符',
        pathTooLong: '分类路径总长度不能超过 {count} 个字符',
      ...
      rule: {
        ...
        matchingRules: '匹配规则',
        add: '新增分类规则',
        limitReached: '最多允许 {count} 条规则',
        simpleModeHint: '基础模式可设置媒体类型、条件和目标分类；条件组合、数据来源及标签等选项可在“高级设置”中调整。',
        itemAria: '规则 {index}：{name}',
        dragAria: '拖拽排序规则 {name}',
        drag: '拖拽排序',
        priority: '优先级 {priority}',
        conditionCount: '{count} 个条件',
        enableAria: '启用规则 {name}',
        actionsAria: '规则操作 {name}',
        moveUp: '上移规则 {name}',
        moveDown: '下移规则 {name}',
        copy: '复制规则 {name}',
        delete: '删除规则 {name}',
        ...
        id: '规则编号',
        idAria: '规则编号 {index}',
        invalidId: '规则编号只能包含小写字母、数字、点、下划线和连字符，且长度不超过 128 个字符。',
        duplicateId: '规则编号“{id}”已存在。',
        kindAria: '规则类型 {name}',
        categoryKind: '分类',
        labelKind: '标签',
        mediaTypes: '媒体类型',
        mediaTypesAria: '媒体类型 {name}',
        sources: '数据来源',
        sourcesHint: '留空表示全部来源',
        sourcesAria: '数据来源 {name}',
        conditions: '匹配条件',
        action: '命中后执行',
        categoryTarget: '归入分类',
        noCategoryOptions: '当前媒体类型没有可用分类',
        categoryTargetAria: '分类目标 {name}',
        labels: '输出标签',
        labelsAria: '标签输出 {name}',
        empty: '暂无分类规则',
        allMediaTypes: '全部媒体',
        allSources: '全部来源',
        labelsSummary: '标签 {labels}',
        unsetLabels: '未设置标签',
        unsetCategory: '未设置分类',
        disabledCategory: '已停用',
        newName: '新规则 {sequence}',
        copyName: '{name} 副本',
      },
      condition: {
        nodeKinds: { condition: '条件', all: '全部', any: '任一', not: '排除' },
        nodeHints: {
        ...
        compatibilityField: '{label}（兼容字段）',
        valueSearchCustom: '搜索名称或代码选择；列表外的来源原值也可输入，按回车确认。',
        valueSearch: '搜索名称或代码，可直接选择条件值。',
        valueFreeform: '此字段没有固定字典，请按媒体预览中的原值填写；多个值逐个输入并按回车确认。',
        supportPartial: '部分支持',
        supportUnavailable: '不可用',
        sourceScopeAll: '未限制数据来源：该规则适用于全部来源。',
        sourceScopeSelected:
          '已选择数据来源：{sources}。多个来源表示任一来源即可命中，系统不会合并不同来源的媒体信息；字段值以当前媒体的实际来源为准。',
        nodeAria: '条件节点，第 {depth} 层',
        nodeKindAria: '条件节点类型',
        maxDepth: '已达最大组深度',
        simpleGroupHint: '当前规则包含多个条件；条件组合方式可在“高级设置”中调整。',
        noAvailableFields: '当前媒体类型没有共同可用的条件字段',
        field: '字段',
        fieldPlaceholder: '搜索风格、年份、国家或字段名称',
        fieldAria: '条件字段',
        operator: '操作符',
        operatorAria: '条件操作符',
        noValue: '此操作符无需值',
        rangeStart: '起始值',
        rangeEnd: '结束值',
        valuePlaceholder: '搜索或输入条件值',
        value: '条件值',
        listAria: '条件值列表',
        booleanAria: '布尔条件值',
        yes: '是',
        no: '否',
        retiredHint: '这条条件从旧分类配置迁移而来，继续按原来的方式匹配，不需要重新配置。',
        retiredReplacement: '新增条件请选“{label}”；更换字段可能改变匹配结果，请先预览。',
        sourceSupportAria: '数据源字段支持提示',
        deleteChild: '删除子条件',
        deleteChildAria: '删除子条件 {index}',
        addChild: '添加条件',
        addChildAvailable: '添加同级条件',
        addChildDisabled: '没有可用字段，或排除已经有条件',
        addChildAria: '添加条件',
      },
      preview: {
        title: '分类结果预览与匹配说明',
        description: '搜索并选择媒体，查看分类结果。预览不会修改当前已发布的规则。',
        run: '预览分类结果',
        modeLabel: '使用哪套规则',
        draftPolicy: '当前编辑中的规则',
        activePolicy: '已发布的规则',
        factsTitle: '媒体信息',
        searchDescription: '无需手动填写字段；搜索并选择媒体后，系统将直接使用该媒体信息进行预览。',
        keyword: '搜索媒体',
        keywordPlaceholder: '输入电影、电视剧、专辑或艺术家名称',
        search: '搜索',
        keywordRequired: '请输入关键词后再搜索',
        noSearchResults: '没有找到可用于预览的媒体信息',
        searchFailed: '媒体搜索失败，请稍后重试',
        searchResults: '媒体搜索结果',
        selectedTitle: '已选择的媒体',
        clearSelection: '清除已选媒体',
        selectedSource: '数据源',
        selectedId: '来源编号',
        selectedType: '媒体类型',
        year: '年份',
        ...
        album: '专辑',
        untitledMedia: '未命名媒体',
        unknownSource: '未登记的数据源',
        selectionRequired: '请先搜索并选择一条媒体信息',
        mediaSource: '媒体来源',
        ...
        resultTitle: '预览结果',
        loading: '正在预览分类结果',
        emptyResult: '选择媒体并执行预览后，可查看匹配说明。',
        status: '状态',
        policyRevision: '规则版本',
        recommended: '规则建议分类',
        effective: '生效分类',
        ...
        fieldLabels: {
          ...
          musicType: '音乐类型',
          albumType: '专辑类型',
          secondaryTypes: '专辑附加类型',
          musicGenres: '音乐流派',
          tags: '音乐标签',
          artists: '艺术家',
          artistCountry: '艺术家国家或地区',
          releaseStatus: '发行状态',
          sourceExtension: '数据源补充信息',
        },
      },
      impact: {
        title: '影响分析',
        description: '读取近期下载与整理记录对应的完整媒体信息，并比较当前规则与待发布规则的分类结果。',
        ...
        analyze: '开始分析',
        scope:
          '最多比较 200 条近期记录并返回 50 条变化示例。无法获取详情的记录将单独列出；分析不会移动文件或修改历史。',
        loading: '正在读取近期记录并比较规则…',
        metadataAria: '影响分析元数据',
        baselineRevision: '当前版本 {revision}',
        candidateRevision: '待发布版本 {revision}',
        sampledAt: '采样于 {time}',
        overviewTitle: '近期记录比较结果',
        truncated: '本次只比较了部分近期记录，未展示的记录不能据此判断是否发生变化。',
        changeTypesTitle: '分类变化类型',
        categoriesTitle: '分类计数对比',
        previousCategoriesAria: '当前规则分类计数',
        candidateCategoriesAria: '待发布规则分类计数',
        ...
        previous: '活动策略',
        candidate: '候选策略',
        emptyExamples: '近期记录中没有可展示的分类变化示例。',
        warningsTitle: '需要注意',
        emptyAnalysis: '还没有生成影响分析。点击“开始分析”后查看近期记录的比较结果。',
        uncategorized: '未分类',
        ...
        sampleSources: {
          request: '本次输入的媒体信息',
          recentHistory: '近期下载与整理记录（会重新获取媒体信息）',
        },
        states: {
          complete: '完整',
          partial: '媒体信息不完整',
        ...
        metrics: {
          ...
          partialCount: '媒体信息仍不完整',
          degradedCount: '待发布结果降级',
        },
        columns: {
          mediaType: '媒体类型',
          source: '数据来源',
      ...
      control: {
        title: '版本发布与历史',
        description: '发布与回退均基于当前版本。如果服务器已被其他操作更新，本地草稿将保留，不会被覆盖。',
        versionLabel: '第 {revision} 版',
        policyStatusAria: '当前策略状态',
        unpublishedChanges: '有未发布修改',
        conflictTitle: '检测到版本冲突',
        conflictDescription:
          '本地操作基于第 {expected} 版，服务器当前是第 {current} 版。本地草稿已保留，请先同步服务器状态并重新分析。',
        ...
        publish: '发布新版本',
        historyTitle: '版本历史',
        historyDescription: '选择历史内容后，服务器会以当前第 {revision} 版为准创建一个新版本。',
        refreshHistory: '刷新版本历史',
        loadingHistory: '正在加载版本历史',
        historyNotLoaded: '尚未加载版本历史',
        historyEmpty: '暂无可回退的历史版本',
        selectHistoryLegend: '选择要恢复的历史版本',
        selectHistoryAria: '选择第 {revision} 版，{categories} 个分类，{rules} 条规则',
        updatedAtUnknown: '更新时间未知',
        categoryCount: '{count} 个分类',
        ruleCount: '{count} 条规则',
        rollbackNotice: '回退不会改写或删除旧版本；所选历史内容会发布为一个全新的版本。',
        rollbackAria: '将所选历史版本发布为新版本',
        selectBeforeRollback: '选择历史版本后回退',
        rollbackRevision: '将第 {revision} 版恢复为新版本',
        publishingStatus: '正在发布基于第 {revision} 版的分类策略',
        keepDraftStatus: '已保留本地草稿，正在重新分析影响',
        rollbackStatus: '正在将第 {revision} 版发布为新版本',
        requirements: {
          dirtyPassed: '存在待发布的草稿修改',
          dirtyPending: '请先修改分类策略草稿',
          validationPassed: '当前草稿已通过服务端校验',
          validationPending: '当前草稿尚未通过服务端校验',
          impactPassed: '影响分析基于当前第 {revision} 版',
          impactPending: '需要对当前草稿执行最新影响分析',
          reviewPassed: '已确认审阅影响分析',
          reviewPending: '尚未确认审阅影响分析',
          conflictPending: '请先处理版本冲突',
          conflictPassed: '当前没有版本冲突',
        },
      },
    },
    about: {
    ...
    system: {
      ...
      musicReleaseRegionPriority: '音乐发行地区优先级',
      musicReleaseRegionPriorityHint: 'MusicBrainz 版本结构同样准确时，按顺序优先选择发行地区，最多 3 项',
      musicReleaseScriptPriority: '音乐文字字形优先级',
      musicReleaseScriptPriorityHint: 'MusicBrainz 版本结构同样准确时，按顺序优先选择标题字形，最多 3 项',
      musicRegionChina: '中国大陆',
      musicRegionTaiwan: '中国台湾',
      musicRegionHongKong: '中国香港',
      musicRegionWorldwide: '全球',
      musicRegionJapan: '日本',
      musicRegionUnitedStates: '美国',
      musicRegionUnitedKingdom: '英国',
      musicRegionSouthKorea: '韩国',
      musicScriptSimplified: '简体中文',
      musicScriptTraditional: '繁体中文',
      musicScriptLatin: '拉丁文字',
      musicScriptJapanese: '日文',
      musicScriptKorean: '韩文',
      ...
      policy: {
        ...
        upgradeDesc: '仅在新歌词质量更高时替换，禁止同步歌词降级为纯文本',
      },
    },
    site: {
      siteSync: '站点同步',
  ...
  dialog: {
    ...
    transferQueue: {
      ...
      manualReviewTitle: '待人工复核',
      manualReviewCount: '{count} 条待处理',
      manualReviewHint: '整理结果不确定，请确认文件是否已经上传后再继续。',
      manualReviewSource: '源文件',
      manualReviewStorage: '存储',
      manualReviewTarget: '目标文件',
      manualReviewOperation: '整理步骤',
      manualReviewDetails: '查看详情',
      manualReviewEvidence: '执行证据',
      manualReviewReasonLabel: '复核说明',
      manualReviewReasonPlaceholder: '请说明你确认文件未上传或已完成的依据',
      manualReviewReasonRequired: '请填写复核说明',
      manualReviewNotApplied: '确认未完成，重新整理',
      manualReviewApplied: '确认已完成，继续后续步骤',
      manualReviewAppliedUnavailable: '当前没有可用于确认完成的目标文件证据，请选择重新整理。',
      manualReviewAppliedWarning: '仅在确认目标文件完整可用时选择此项；整理计划可能继续执行后续步骤，包括删除源文件。',
      manualReviewSubmitted: '人工复核已提交',
      manualReviewSubmitFailed: '人工复核提交失败，请刷新后重试',
      manualReviewLoadFailed: '待人工复核任务加载失败',
      manualReviewRetry: '重新加载',
      manualReviewRetryWait: '后台重试中',
      manualReviewRetryWaitHint: '已确认未完成，任务已交还后台重试；可在整理历史查看最终结果。',
    },
    reorganize: {
      title: '整理',
      sourceTitle: '源文件',
      ...
      musicEntity: '音乐实体',
      artistCollection: '艺术家合集',
      artistCollectionHint:
        '把当前目录作为合集容器：一级子目录分别按专辑整理，“单曲”目录及根目录音频按单曲整理。各条目独立识别和提交，单项失败不会中断整个合集。',
      artistCollectionRequiresDirectory: '艺术家合集模式仅支持选择一个目录',
      artistCollectionEmpty: '当前目录没有可整理的专辑子目录或音频文件',
      artistCollectionSingles: '单曲',
      artistCollectionProgress: '正在处理 {current}/{total}：{name}',
      artistCollectionTrackCount: '{count} 项',
      artistCollectionGroupCount: '专辑 / 单曲分组',
      ...
      musicReleaseScripts: '文字字形顺序',
      musicReleaseScriptsHint: '控制版本选择；最终是否强制简体仍由系统音乐转换开关决定',
      musicRegionChina: '中国大陆',
      musicRegionTaiwan: '中国台湾',
      musicRegionHongKong: '中国香港',
      musicRegionWorldwide: '全球',
      ...
      overwriteSkippedHint: '目标已有文件，当前覆盖策略跳过了这项；调整覆盖策略或移除旧文件后重新整理',
      ...
      historySkipped: '检测到 {count} 条成功整理记录。将跳过这些记录，保留其目标文件和历史记录，仅整理其余文件。',
      skipSuccessfulRecords: '跳过已成功整理记录',
      auto: '自动',
      processing: '正在处理 ...',
  ...
  plugin: {
    ...
    sourceBindingRequiredHint: '该插件尚未绑定仓库，请在「关于」中确认',
    restartRequiredBadge: '重启后生效',
    restartRequiredBadgeHint: '当前插件仍可使用，重启 MoviePilot 后完整生效',
    installRestartRequired: '插件 {name} 已安装，重启 MoviePilot 后完成依赖更新',
    updateRestartRequired: '插件 {name} 已更新，重启 MoviePilot 后完成依赖更新',
    sourceChangeRestartRequired: '插件 {name} 的仓库已更换，重启 MoviePilot 后完成依赖更新',
    sourceConflictHint: '检测到多个同名插件，请选择仓库。',
    sourceLocalAndOnlineHint: '检测到本地和在线来源，请选择安装来源。',
    sourceMultipleOnlineHint: '检测到官方和第三方仓库，请选择安装来源。',
    sourceMultipleThirdPartyHint: '检测到多个第三方仓库，请选择安装来源。',
    sourceThirdPartyHint: '该插件来自第三方仓库，请确认后安装。',
    sourceSelectionRequired: '需选择',
    ...
    confirmThirdPartyInstall: '将从 {target} 安装「{name}」。',
    ...
    noRecentPlugins: '无',
    instanceManage: '实例管理',
    instanceManageTitle: '{name} 实例管理',
    instanceManageHint: '这里的设置按实例各管各的：列出该插件的本体与全部在册分身，改动立即生效，无需重启。',
    instanceLoadFailed: '实例列表加载失败，请稍后重试',
    instanceRefreshFailed: '操作已完成，但实例列表刷新失败，请手动重试',
    instanceOverlayFailed: '已安装插件清单读取失败，实例展示名与默认调用目标暂不可用',
    instanceHost: '本体',
    instanceClone: '分身',
    instancesEmpty: '暂无实例',
    instanceCurrent: '当前',
    defaultTarget: '默认调用目标',
    defaultTargetSet: '设为默认调用目标',
    defaultTargetClear: '取消默认调用目标',
    defaultTargetOnlyOneHint: '每个插件同一时间至多一个默认调用目标，设为默认会自动取消原来的那个。',
    defaultTargetMissingWarning:
      '尚未指定默认调用目标：在指定之前，没有点名实例的外部调用（例如工作流动作）会直接失败——系统不会随机挑一个，也不会取第一个实例。',
    defaultTargetSingleInstanceHint: '该插件只有本体、没有分身，未指定实例的调用直接落到本体，无需设置默认调用目标。',
    defaultTargetSetSuccess: '已将该实例设为默认调用目标',
    defaultTargetClearSuccess: '已取消该实例的默认调用目标',
    defaultTargetFailed: '操作失败：{message}',
    instanceDisabled: '已停用',
    instanceDisabledFacts: '业务参数与展示信息仍在，启用即恢复',
    instanceDisable: '停用',
    instanceEnable: '启用',
    instanceDisableConfirm: '确认停用',
    instanceDisableKeepsConfig: '停用不是删除：这个实例的业务参数与展示信息原样留在原处，再次启用即恢复。',
    instanceDisableClearsPlacements: '只对在册实例有意义的两项会被清掉：默认调用目标置位与日志等级覆盖。',
    instanceDisableLeavesList: '停用后它会离开实例列表，本次弹窗内仍可撤销。',
    instanceDisableDefaultTargetWarning: '它是当前的默认调用目标，停用后没有点名实例的调用会失败，直到重新指定。',
    instanceDisableSuccess: '{name} 已停用，配置已保留',
    instanceDisableFailed: '停用失败：{message}',
    instanceEnableSuccess: '{name} 已启用',
    instanceEnableFailed: '启用失败：{message}',
    logLevelFollowGlobal: '跟随全局',
    logLevelConfigured: '已配置：{level}',
    logLevelEffective: '生效：{level}',
    logLevelExpiresAt: '{time} 失效',
    logLevelEdit: '设置等级',
    logLevelSelectLabel: '日志等级',
    logLevelExpiresLabel: '失效时间（可选）',
    logLevelExpiresHint: '留空表示不过期',
    logLevelSetSuccess: '日志等级已更新',
    logLevelSetFailed: '设置失败：{message}',
    logLevelClear: '清除覆盖',
    logLevelClearSuccess: '已清除日志等级覆盖，回落全局等级',
    logLevelClearFailed: '清除失败：{message}',
  },
  profile: {
    personalInfo: '个人信息',
  ...
  transferRecovery: {
    ...
    'source': '源路径：',
    'target': '目标路径：',
    'targetUnknown': '尚未生成目标路径',
    'stage': '失败阶段：',
    'next': '下一步：',
    'attempts': '累计失败 {count} 次',
    'skipped': '覆盖跳过',
    'pauseHint':
      '此文件的自动整理已暂停。修复原因后点击“重新整理”。也可仅删除失败记录后重新扫描；下载器任务还需移除“已整理”标签。其他文件不受影响。',
    'cleanupHint': '媒体已入库。请先在下载器完成清理，再确认状态；无需重新移动媒体文件。',
    'cleanupConfirm': '我已在下载器完成该任务的清理',
    'resolveCleanup': '已手动清理下载器',
    'cleanupDone': '下载器清理告警已关闭。',
    'detachConfirm': '尝试解除失效任务绑定，保留历史和文件；运行中或待人工复核的任务不能解除',
    'detach': '解除失效任务绑定',
    'detachDone': '任务绑定已解除，可点击“重新整理”生成新计划。',
    'queue': '查看整理队列',
    'requestFailed': '操作失败，请刷新状态后重试',
    'unknownReason': '未记录具体原因，请查看整理日志',
    'defaultAction': '检查源文件、路径映射及目标存储后重新整理。',
    'reviewFailureHint': '判定尚未提交，任务仍待复核。请按上方原因处理；若状态已变化，关闭弹窗后刷新队列再检查。',
    'batchTitle': '本次提交结果',
    'batchHint': '已接收表示后台将处理，请在整理队列或整理历史查看最终结果。再次提交前请核对每项状态，避免重复操作。',
    'states': {
      'accepted': '已接收 · 等待后台处理',
      'completed': '已完成',
      'failed': '失败',
  ...
  transferHistory: {
    ...
    status: {
      ...
      failed: '失败',
      paused: '自动暂停',
      cleanupFailed: '下载器清理失败',
      unknown: '未知',
    },
    failureStage: '失败阶段：{stage}',
    recoveryAction: '下一步：{action}',
    retryStatus: '已尝试 {count}/{max} 次',
    autoPausedHint: '自动整理已暂停，请修复原因后重新整理，或删除失败记录后重新扫描',
    cleanupFailedHint: '媒体已入库，但下载器任务清理失败，请检查下载器任务状态',
    cleanupResolved: '已确认下载器任务人工清理完成',
    cleanupResolveFailed: '确认下载器清理状态失败，请刷新后重试',
    failureStages: {
      source_access: '源文件访问',
      recognition: '媒体识别',
      planning: '整理计划',
      destination_access: '目标存储访问',
      transfer: '文件转移',
      overwrite: '覆盖策略',
      downloader_cleanup: '下载器清理',
      execution: '任务执行',
      unknown: '未知阶段',
    },
    statusFilter: {
  ...
  mediaserver: {
    ...
    mediaVaultHostHint: 'MediaVault 管理面板地址（默认端口 7811），不是自建媒体库的播放端口',
    mediaVaultApiKeyHint: 'MediaVault 管理面板->系统配置->API Key 中生成的密钥',
  ...
  initialization: {
    ...
    password: '设置密码',
    passwordPlaceholder: '至少 6 位，包含字母、数字或特殊字符',
    passwordHint: '建议使用同时包含字母、数字和特殊字符的强密码',
    confirmPassword: '再次输入密码',
    confirmPasswordPlaceholder: '再次确认你的密码',
    passwordMismatch: '两次输入的密码不一致',
    apiKeySection: 'API 访问密钥',
    apiKey: '生成 API Key',
    apiKeyHint: '用于脚本、外部客户端和插件访问 API',
    generated: '已生成',
    copyApiKey: '复制 API Key',
    apiKeyCopied: 'API Key 已复制',
    apiKeyWarning: '请妥善保存，保存后仍可在系统设置中更换',
    regenerate: '重新生成',
    saveAndContinue: '保存并前往登录',
