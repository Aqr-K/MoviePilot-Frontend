export default {
  ...
  plugin: {
    ...
    allPlugins: '所有插件',
    noRecentPlugins: '无',
    logLevelManage: '实例日志等级',
    logLevelManageTitle: '{name} 实例日志等级',
    logLevelScopeHint: '日志等级按实例各管各的。这里列出该插件的本体与全部分身，改动立即生效，无需重启。',
    logLevelLoadFailed: '实例日志等级加载失败，请稍后重试',
    logLevelRefreshFailed: '操作已完成，但实例日志等级刷新失败，请手动重试',
    instanceHost: '本体',
    instanceClone: '分身',
    instancesEmpty: '暂无实例',
    logLevelCurrentInstance: '当前',
