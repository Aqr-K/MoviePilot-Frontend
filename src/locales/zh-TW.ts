export default {
  common: {
    ...
    networkConnectionFailed: '網絡連接失敗',
    requestTimeout: '請求超時',
  ...
  theme: {
    ...
    glassUIStyle: '介面風格',
    glassUIStyleAdaptive: '自適應',
    glassUIStyleClear: '通透',
    glassUIStyleHint: '同時套用至頂欄、底部懸浮導覽列、彈出選單、彈出視窗和 FAB 懸浮按鈕。',
    glassQuality: '品質',
    glassQualityCss: '標準',
  ...
  music: {
    ...
    discographyDescription: '按官方作品集查看媒體庫與站點資源，已入庫作品預設不選中。',
    discographyLoadFailed: '載入藝術家作品失敗',
    artistCollectionResources: '藝術家合集資源',
    artistCollectionDescription:
      '按藝術家搜尋大合集種子；一份資源可覆蓋多張官方作品，下載源目錄統一歸入 Artist Collection。',
    downloadArtistCollection: '下載大合集',
    downloadArtistCollectionConfirm: '確定使用預設下載器下載「{title}」嗎？',
    artistCollectionDownloadAdded: '藝術家合集已加入下載',
    estimatedCoverage: '預計覆蓋 {count}/{total} 個官方作品',
    coverageUnknown: '覆蓋範圍需查看資源詳情',
    unknownSite: '未知站點',
    seeders: '{count} 做種',
    officialWorks: '官方作品',
    statusInLibrary: '已入庫',
    notInLibrary: '未入庫',
    selectDownloadable: '選中可下載',
    batchDownload: '批次下載',
    batchDownloadConfirm: '確定使用預設下載器下載選中的 {count} 個作品嗎？',
    batchDownloadResult: '批次下載已處理：{success}/{total} 個成功',
    newestFirst: '最新優先',
    oldestFirst: '最早優先',
    rematchResources: '重新匹配',
    noOfficialWorks: '沒有找到可顯示的官方作品',
    selectAlbum: '選擇專輯 {title}',
    unknownReleaseDate: '發行日期未知',
  ...
  agentAssistant: {
    ...
    steeringPlaceholder: '任務執行中，可補充消息...',
    steeringQueued: '已排隊',
  ...
  subscribe: {
    ...
    execution: {
      details: '搜尋詳情',
      autoResume: '站點暫時繁忙，系統會自動繼續搜尋，無需重複操作。',
      taskResume: '目前任務結束後，系統會自動繼續搜尋，無需重複操作。',
      resumeAt: '預計 {time} 自動繼續（本地時間）',
      resumeDue: '已到預計時間，正在等待自動繼續。',
      failedHint: '本次搜尋未完成，可重新搜尋；若持續出現，請檢查站點。',
      failureDetails: '查看失敗詳情',
      retry: '重新搜尋',
      checkSites: '檢查站點',
      searchSubmitted: '{name} 已安排搜索',
      searchScheduled: '{name} 已安排搜索，很快開始',
      searchAlreadyRunning: '{name} 已經在搜索中，請稍候',
    ...
    maintenance: {
      title: '訂閱維護',
      searchAll: '搜索目前媒體類型訂閱',
      searchAllConfirmTitle: '確認搜索目前媒體類型訂閱',
      searchAllConfirm:
        '系統會依次搜索目前帳號可存取的目前媒體類型訂閱，並存取相應站點。訂閱較多時需要一些時間，是否繼續？',
      searchAllStarted: '目前媒體類型訂閱搜索已安排！',
      searchAllEmpty: '目前媒體類型沒有需要搜索的訂閱',
      searchAllAlreadyRunning: '{count} 個目前媒體類型訂閱已經在搜索中，請稍候',
      searchAllMixed: '已安排 {queued} 個目前媒體類型訂閱搜索，另有 {ongoing} 個正在處理中',
      searchAllScheduled: '已安排 {count} 個目前媒體類型訂閱，系統會自動依次搜索',
      refresh: '刷新訂閱資源',
  ...
  setting: {
    classification: {
      title: '媒體自動分類',
      description: '符合條件的媒體會自動歸入對應目錄。請依次完成以下 3 個步驟。',
      workspaceCategories: '1. 設定目錄',
      workspaceRules: '2. 設定規則',
      workspaceReview: '3. 測試並儲存',
      quickGuideEyebrow: '設定流程',
      quickGuideTitle: '自動分類設定流程',
      quickGuideHint: '請先設定存放目錄，再設定匹配規則，最後預覽分類結果並儲存。',
      quickGuideAria: '自動分類設定步驟',
      quickGuideSteps: {
        categories: { title: '設定目錄', hint: '設定媒體存放目錄' },
        rules: { title: '設定規則', hint: '設定媒體匹配條件' },
        review: { title: '測試並儲存', hint: '驗證分類結果並套用' },
      },
      ...
      restoreDefaults: '恢復內建預設規則',
      restoreDefaultsConfirm: '將用內建預設分類規則取代目前草稿，尚未發佈的修改會被覆蓋。確定要繼續嗎？',
      defaultsLoaded: '已恢復內建預設分類規則，請校驗後發佈',
      defaultsLoadFailed: '內建預設分類規則載入失敗',
      enrichmentTitle: '分類資訊來源',
      enrichmentSimpleTitle: '補充資訊（可選）',
      enrichmentSimpleHint: '通常無需調整。僅當規則所需資訊未由主要資料源提供時，系統才會嘗試補充。',
      enrichmentSimpleNote: '目前使用預設設定：僅在必要時補充缺少資訊，不會改變媒體的主要資料源。',
      enrichmentHint:
      ...
      analysisHint: '發佈前可查看分類命中結果、變更影響並確認歷史版本。',
      simpleReviewTitle: '驗證分類結果並儲存',
      simpleReviewHint: '搜尋並選擇一筆媒體，確認分類結果。校驗通過後，點擊「確認並套用」。',
      simpleReviewCheck: '檢查目前規則',
      simpleReviewApply: '確認並套用',
      simpleReviewImpact: '已檢查 {sample} 筆近期記錄：{changed} 筆分類將發生變更，{degraded} 筆結果可能降級。',
      previewTab: '結果預覽',
      impactTab: '影響分析',
      publishTab: '發佈與歷史',
      previewFailed: '分類預覽請求失敗',
      impactFailed: '分類影響分析失敗',
      publishSucceeded: '分類規則已發佈為第 {revision} 版',
      publishFailed: '分類策略發佈失敗',
      remoteReloaded: '已重新載入服務端活動策略',
      remoteReloadFailed: '重新載入服務端策略失敗',
      historyFailed: '分類策略歷史載入失敗',
      rollbackSucceeded: '第 {source} 版已恢復，並發佈為第 {revision} 版',
      rollbackFailed: '分類策略還原失敗',
      directoryReferencesUnavailable: '目錄引用載入失敗',
      directoryReferencesUnavailableHint: '目前無法顯示完整目錄引用保護；服務端仍會在校驗和發佈時阻止無效變更。',
      helpButton: '查看自動分類說明',
      helpTitle: '自動分類使用說明',
      helpDescription: '請依序完成設定、校驗和發佈。',
      helpClose: '知道了',
      help: {
        sections: {
          categories: {
      ...
      category: {
        title: '存放目錄',
        description:
          '設定媒體分類目錄。規則命中後，媒體將歸入對應目錄；未命中時使用預設目錄。路徑最多支援 {count} 級。',
        add: '新增{mediaType}分類',
        ...
        fallbackTitle: '未匹配媒體的預設分類',
        fallbackHint: '當所有分類規則均未命中時，媒體將歸入所選分類。該分類與規則中的「歸入分類」共用同一分類列表。',
        fallbackFor: '{mediaType}預設分類',
        fallbackBadge: '預設分類',
        legacyHint: '此分類是在舊版遷移時建立的備用目錄，僅在被規則、預設分類或目錄設定引用時使用。',
        pathRequired: '分類路徑不能為空',
        pathEmptySegment: '分類路徑不能包含空層級',
        pathTooDeep: '分類路徑最多支援 {count} 級',
        duplicatePath: '同一媒體類型下不能使用重複分類路徑',
        pathSegmentTooLong: '分類路徑單段不能超過 {count} 個字元',
        pathTooLong: '分類路徑總長度不能超過 {count} 個字元',
      ...
      rule: {
        ...
        matchingRules: '匹配規則',
        add: '新增分類規則',
        limitReached: '最多允許 {count} 條規則',
        simpleModeHint: '基礎模式可設定媒體類型、條件和目標分類；條件組合、資料源及標籤等選項可在「進階設定」中調整。',
        itemAria: '規則 {index}：{name}',
        dragAria: '拖曳排序規則 {name}',
        drag: '拖曳排序',
        priority: '優先級 {priority}',
        conditionCount: '{count} 個條件',
        enableAria: '啟用規則 {name}',
        actionsAria: '規則操作 {name}',
        moveUp: '上移規則 {name}',
        moveDown: '下移規則 {name}',
        copy: '複製規則 {name}',
        delete: '刪除規則 {name}',
        ...
        id: '規則編號',
        idAria: '規則編號 {index}',
        invalidId: '規則編號只能包含小寫字母、數字、點、底線和連字號，長度不能超過 128 個字元。',
        duplicateId: '規則編號「{id}」已存在。',
        kindAria: '規則類型 {name}',
        categoryKind: '分類',
        labelKind: '標籤',
        mediaTypes: '媒體類型',
        mediaTypesAria: '媒體類型 {name}',
        sources: '資料源',
        sourcesHint: '留空表示全部資料源',
        sourcesAria: '資料源 {name}',
        conditions: '匹配條件',
        action: '命中後執行',
        categoryTarget: '歸入分類',
        noCategoryOptions: '目前媒體類型沒有可用分類',
        categoryTargetAria: '分類目標 {name}',
        labels: '輸出標籤',
        labelsAria: '標籤輸出 {name}',
        empty: '暫無分類規則',
        allMediaTypes: '全部媒體',
        allSources: '全部資料源',
        labelsSummary: '標籤 {labels}',
        unsetLabels: '未設定標籤',
        unsetCategory: '未設定分類',
        disabledCategory: '已停用',
        newName: '新規則 {sequence}',
        copyName: '{name} 副本',
      },
      condition: {
        nodeKinds: { condition: '條件', all: '全部', any: '任一', not: '排除' },
        nodeHints: {
          condition: '單個條件只判斷一個欄位。選擇「全部」或「任一」後，可以新增同級條件。',
          all: '全部滿足：所有條件都滿足時，規則才會命中。',
          any: '任一滿足：只要有一個條件滿足，規則就會命中。',
          not: '排除：括號內條件滿足時，規則不會命中。',
        },
        operators: {
          equals: '等於',
          not_equals: '不等於',
        ...
        compatibilityField: '{label}（相容欄位）',
        valueSearchCustom: '搜尋名稱或代碼選擇；列表外的來源原值也可輸入，按 Enter 確認。',
        valueSearch: '搜尋名稱或代碼，可直接選擇條件值。',
        valueFreeform: '此欄位沒有固定字典，請按媒體預覽中的原值填寫；多個值逐個輸入並按 Enter 確認。',
        supportPartial: '部分支援',
        supportUnavailable: '不可用',
        sourceScopeAll: '未限制資料源：該規則適用於全部資料源。',
        sourceScopeSelected:
          '已選擇資料源：{sources}。多個資料源表示任一資料源即可命中，系統不會合併不同資料源的媒體資訊。',
        nodeAria: '條件節點，第 {depth} 層',
        nodeKindAria: '條件節點類型',
        maxDepth: '已達最大組深度',
        simpleGroupHint: '目前規則包含多個條件；條件組合方式可在「進階設定」中調整。',
        noAvailableFields: '目前媒體類型沒有共同可用的條件欄位',
        field: '欄位',
        fieldPlaceholder: '搜尋風格、年份、國家或欄位名稱',
        fieldAria: '條件欄位',
        operator: '操作符',
        operatorAria: '條件操作符',
        noValue: '此操作符無需值',
        rangeStart: '起始值',
        rangeEnd: '結束值',
        valuePlaceholder: '搜尋或輸入條件值',
        value: '條件值',
        listAria: '條件值列表',
        booleanAria: '布林條件值',
        yes: '是',
        no: '否',
        retiredHint: '這條條件從舊分類設定遷移而來，繼續按原來的方式匹配，不需要重新設定。',
        retiredReplacement: '新增條件請選「{label}」；更換欄位可能改變匹配結果，請先預覽。',
        sourceSupportAria: '資料源欄位支援提示',
        deleteChild: '刪除子條件',
        deleteChildAria: '刪除子條件 {index}',
        addChild: '新增條件',
        addChildAvailable: '新增同級條件',
        addChildDisabled: '沒有可用欄位，或排除已經有條件',
        addChildAria: '新增條件',
      },
      preview: {
        title: '分類結果預覽與命中說明',
        description: '搜尋並選擇媒體，查看分類結果。預覽不會修改目前已發佈的規則。',
        run: '預覽分類結果',
        modeLabel: '使用哪套規則',
        draftPolicy: '目前編輯中的規則',
        activePolicy: '已發佈的規則',
        factsTitle: '媒體資訊',
        searchDescription: '無需手動填寫欄位；搜尋並選擇媒體後，系統將直接使用該媒體資訊進行預覽。',
        keyword: '搜尋媒體',
        keywordPlaceholder: '輸入電影、電視劇、專輯或歌手名稱',
        search: '搜尋',
        keywordRequired: '請輸入關鍵字後再搜尋',
        noSearchResults: '找不到可用於預覽的媒體資訊',
        searchFailed: '媒體搜尋失敗，請稍後再試',
        searchResults: '媒體搜尋結果',
        selectedTitle: '已選擇的媒體',
        clearSelection: '清除已選媒體',
        selectedSource: '資料源',
        selectedId: '來源編號',
        selectedType: '媒體類型',
        year: '年份',
        ...
        album: '專輯',
        untitledMedia: '未命名媒體',
        unknownSource: '未登記的資料源',
        selectionRequired: '請先搜尋並選擇一筆媒體資訊',
        mediaSource: '媒體來源',
        ...
        resultTitle: '預覽結果',
        loading: '正在預覽分類結果',
        emptyResult: '選擇媒體並執行預覽後，可查看命中說明。',
        status: '狀態',
        policyRevision: '規則版本',
        recommended: '規則建議分類',
        effective: '生效分類',
        ...
        fieldLabels: {
          ...
          musicType: '音樂類型',
          albumType: '專輯類型',
          secondaryTypes: '專輯附加類型',
          musicGenres: '音樂流派',
          tags: '音樂標籤',
          artists: '歌手',
          artistCountry: '歌手國家或地區',
          releaseStatus: '發行狀態',
          sourceExtension: '資料源補充資訊',
        },
      },
      impact: {
        title: '影響分析',
        description: '讀取近期下載與整理記錄對應的完整媒體資訊，並比較目前規則與待發佈規則的分類結果。',
        ...
        analyze: '開始分析',
        scope:
          '最多比較 200 筆近期記錄並傳回 50 筆變更範例。無法取得詳情的記錄將單獨列出；分析不會移動檔案或修改歷史。',
        loading: '正在讀取近期記錄並比較規則…',
        metadataAria: '影響分析中繼資料',
        baselineRevision: '目前版本 {revision}',
        candidateRevision: '待發佈版本 {revision}',
        sampledAt: '取樣於 {time}',
        overviewTitle: '近期記錄比較結果',
        truncated: '本次只比較了部分近期記錄，未顯示的記錄不能據此判斷是否發生變更。',
        changeTypesTitle: '分類變更類型',
        categoriesTitle: '分類計數比較',
        previousCategoriesAria: '目前規則分類計數',
        candidateCategoriesAria: '待發佈規則分類計數',
        ...
        previous: '活動策略',
        candidate: '候選策略',
        emptyExamples: '近期記錄中沒有可顯示的分類變更範例。',
        warningsTitle: '需要注意',
        emptyAnalysis: '尚未產生影響分析。執行「開始分析」後可查看近期記錄的比較結果。',
        uncategorized: '未分類',
        ...
        sampleSources: {
          request: '本次輸入的媒體資訊',
          recentHistory: '近期下載與整理記錄（會重新取得媒體資訊）',
        },
        states: {
          complete: '完整',
          partial: '媒體資訊不完整',
        ...
        metrics: {
          ...
          partialCount: '媒體資訊仍不完整',
          degradedCount: '待發佈結果降級',
        },
        columns: {
          mediaType: '媒體類型',
          source: '資料來源',
      ...
      control: {
        title: '版本發佈與歷史',
        description: '發佈與回退均基於目前版本。如果伺服器已由其他操作更新，本機草稿將保留，不會被覆寫。',
        versionLabel: '第 {revision} 版',
        policyStatusAria: '目前策略狀態',
        unpublishedChanges: '有尚未發佈的修改',
        conflictTitle: '偵測到版本衝突',
        conflictDescription:
          '本機操作以第 {expected} 版為基準，伺服器目前是第 {current} 版。本機草稿已保留，請先同步伺服器狀態並重新分析。',
        ...
        publish: '發佈新版本',
        historyTitle: '版本歷史',
        historyDescription: '選擇歷史內容後，伺服器會以目前第 {revision} 版為準建立新版本。',
        refreshHistory: '重新整理版本歷史',
        loadingHistory: '正在載入版本歷史',
        historyNotLoaded: '尚未載入版本歷史',
        historyEmpty: '目前沒有可還原的歷史版本',
        selectHistoryLegend: '選擇要還原的歷史版本',
        selectHistoryAria: '選擇第 {revision} 版，{categories} 個分類，{rules} 條規則',
        updatedAtUnknown: '更新時間未知',
        categoryCount: '{count} 個分類',
        ruleCount: '{count} 條規則',
        rollbackNotice: '回退不會改寫或刪除舊版本；所選歷史內容會發佈為全新的版本。',
        rollbackAria: '將所選歷史版本發佈為新版本',
        selectBeforeRollback: '選擇歷史版本後還原',
        rollbackRevision: '將第 {revision} 版恢復為新版本',
        publishingStatus: '正在發佈以第 {revision} 版為基準的分類策略',
        keepDraftStatus: '已保留本機草稿，正在重新分析影響',
        rollbackStatus: '正在將第 {revision} 版發佈為新版本',
        requirements: {
          dirtyPassed: '存在待發佈的草稿修改',
          dirtyPending: '請先修改分類策略草稿',
          validationPassed: '目前草稿已通過伺服器驗證',
          validationPending: '目前草稿尚未通過伺服器驗證',
          impactPassed: '影響分析以目前第 {revision} 版為基準',
          impactPending: '需要對目前草稿執行最新影響分析',
          reviewPassed: '已確認審閱影響分析',
          reviewPending: '尚未確認審閱影響分析',
          conflictPending: '請先處理版本衝突',
          conflictPassed: '目前沒有版本衝突',
        },
      },
    },
    about: {
    ...
    system: {
      ...
      modulesLoadFailed: '模組列表載入失敗，請重新整理後重試。',
      downloaders: '下載器',
      ...
      musicReleaseScriptPriority: '音樂文字字形優先級',
      musicReleaseScriptPriorityHint: 'MusicBrainz 版本結構同樣準確時，按順序優先選擇標題字形，最多 3 項',
      musicRegionChina: '中國大陸',
      musicRegionTaiwan: '中國台灣',
      musicRegionHongKong: '中國香港',
      musicRegionWorldwide: '全球',
      musicRegionJapan: '日本',
      musicRegionUnitedStates: '美國',
      musicRegionUnitedKingdom: '英國',
      musicRegionSouthKorea: '韓國',
      musicScriptSimplified: '簡體中文',
      musicScriptTraditional: '繁體中文',
      musicScriptLatin: '拉丁文字',
      musicScriptJapanese: '日文',
      musicScriptKorean: '韓文',
      ...
      mediaGroups: {
        modules: {
          title: '媒體模組',
          description: '按需啟用媒體識別、探索、歌詞和藝術圖模組；核心模組始終啟用。',
        },
        recognition: {
          title: '通用識別',
      ...
      policy: {
        ...
        upgradeDesc: '僅在新歌詞品質更高時替換，禁止同步歌詞降級為純文字',
      },
    },
    site: {
      siteSync: '站點同步',
  ...
  dialog: {
    ...
    transferQueue: {
      ...
      manualReviewTitle: '待人工覆核',
      manualReviewCount: '{count} 條待處理',
      manualReviewHint: '整理結果不確定，請確認文件是否已上傳後再繼續。',
      manualReviewSource: '來源文件',
      manualReviewStorage: '儲存',
      manualReviewTarget: '目標文件',
      manualReviewOperation: '整理步驟',
      manualReviewDetails: '查看詳情',
      manualReviewEvidence: '執行證據',
      manualReviewReasonLabel: '覆核說明',
      manualReviewReasonPlaceholder: '請說明你確認文件未上傳或已完成的依據',
      manualReviewReasonRequired: '請填寫覆核說明',
      manualReviewNotApplied: '確認未完成，重新整理',
      manualReviewApplied: '確認已完成，繼續後續步驟',
      manualReviewAppliedUnavailable: '目前沒有可用於確認完成的目標文件證據，請選擇重新整理。',
      manualReviewAppliedWarning:
        '僅在確認目標文件完整可用時選擇此項；整理計劃可能繼續執行後續步驟，包括刪除來源文件。',
      manualReviewSubmitted: '人工覆核已提交',
      manualReviewSubmitFailed: '人工覆核提交失敗，請刷新後重試',
      manualReviewLoadFailed: '待人工覆核任務載入失敗',
      manualReviewRetry: '重新載入',
      manualReviewRetryWait: '背景重試中',
      manualReviewRetryWaitHint: '已確認未完成，任務已交還背景重試；可在整理歷史查看最終結果。',
    },
    reorganize: {
      title: '整理',
      sourceTitle: '源文件',
      ...
      musicEntity: '音樂實體',
      artistCollection: '藝術家合集',
      artistCollectionHint:
        '把目前目錄作為合集容器：一級子目錄分別按專輯整理，「單曲」目錄及根目錄音訊按單曲整理。各項目獨立識別和提交，單項失敗不會中斷整個合集。',
      artistCollectionRequiresDirectory: '藝術家合集模式僅支援選擇一個目錄',
      artistCollectionEmpty: '目前目錄沒有可整理的專輯子目錄或音訊檔案',
      artistCollectionSingles: '單曲',
      artistCollectionProgress: '正在處理 {current}/{total}：{name}',
      artistCollectionTrackCount: '{count} 項',
      artistCollectionGroupCount: '專輯 / 單曲分組',
      ...
      musicReleaseScripts: '文字字形順序',
      musicReleaseScriptsHint: '控制版本選擇；最終是否強制簡體仍由系統音樂轉換開關決定',
      musicRegionChina: '中國大陸',
      musicRegionTaiwan: '中國台灣',
      musicRegionHongKong: '中國香港',
      musicRegionWorldwide: '全球',
      ...
      overwriteSkippedHint: '目標已有檔案，目前覆蓋策略跳過了這項；調整覆蓋策略或移除舊檔案後重新整理',
  ...
  plugin: {
    ...
    updateRestartRequired: '插件 {name} 已更新，重啟 MoviePilot 後完成依賴更新',
    sourceChangeRestartRequired: '插件 {name} 的倉庫已更換，重啟 MoviePilot 後完成依賴更新',
    sourceConflictHint: '偵測到多個同名插件，請選擇倉庫。',
    sourceThirdPartyHint: '該插件來自第三方倉庫，請確認後安裝。',
    sourceSelectionRequired: '需選擇',
    ...
    confirmThirdPartyInstall: '將從 {target} 安裝「{name}」。',
    ...
    noRecentPlugins: '無',
    instanceManage: '實例管理',
    instanceManageTitle: '{name} 實例管理',
    instanceManageHint: '這裡的設置按實例各管各的：列出該插件的本體與全部在冊分身，改動立即生效，無需重啟。',
    instanceLoadFailed: '實例列表加載失敗，請稍後重試',
    instanceRefreshFailed: '操作已完成，但實例列表刷新失敗，請手動重試',
    instanceOverlayFailed: '已安裝插件清單讀取失敗，實例展示名與默認調用目標暫不可用',
    instanceHost: '本體',
    instanceClone: '分身',
    instancesEmpty: '暫無實例',
    instanceCurrent: '當前',
    defaultTarget: '默認調用目標',
    defaultTargetSet: '設為默認調用目標',
    defaultTargetClear: '取消默認調用目標',
    defaultTargetOnlyOneHint: '每個插件同一時間至多一個默認調用目標，設為默認會自動取消原來的那個。',
    defaultTargetMissingWarning:
      '尚未指定默認調用目標：在指定之前，沒有點名實例的外部調用（例如工作流動作）會直接失敗——系統不會隨機挑一個，也不會取第一個實例。',
    defaultTargetSingleInstanceHint: '該插件只有本體、沒有分身，未指定實例的調用直接落到本體，無需設置默認調用目標。',
    defaultTargetSetSuccess: '已將該實例設為默認調用目標',
    defaultTargetClearSuccess: '已取消該實例的默認調用目標',
    defaultTargetFailed: '操作失敗：{message}',
    instanceDisabled: '已停用',
    instanceDisabledFacts: '業務參數與展示信息仍在，啟用即恢復',
    instanceDisable: '停用',
    instanceEnable: '啟用',
    instanceDisableConfirm: '確認停用',
    instanceDisableKeepsConfig: '停用不是刪除：這個實例的業務參數與展示信息原樣留在原處，再次啟用即恢復。',
    instanceDisableClearsPlacements: '只對在冊實例有意義的兩項會被清掉：默認調用目標置位與日誌等級覆蓋。',
    instanceDisableLeavesList: '停用後它會離開實例列表，本次彈窗內仍可撤銷。',
    instanceDisableDefaultTargetWarning: '它是當前的默認調用目標，停用後沒有點名實例的調用會失敗，直到重新指定。',
    instanceDisableSuccess: '{name} 已停用，配置已保留',
    instanceDisableFailed: '停用失敗：{message}',
    instanceEnableSuccess: '{name} 已啟用',
    instanceEnableFailed: '啟用失敗：{message}',
    logLevelFollowGlobal: '跟隨全局',
    logLevelConfigured: '已配置：{level}',
    logLevelEffective: '生效：{level}',
    logLevelExpiresAt: '{time} 失效',
    logLevelEdit: '設置等級',
    logLevelSelectLabel: '日誌等級',
    logLevelExpiresLabel: '失效時間（可選）',
    logLevelExpiresHint: '留空表示不過期',
    logLevelSetSuccess: '日誌等級已更新',
    logLevelSetFailed: '設置失敗：{message}',
    logLevelClear: '清除覆蓋',
    logLevelClearSuccess: '已清除日誌等級覆蓋，回落全局等級',
    logLevelClearFailed: '清除失敗：{message}',
  },
  profile: {
    personalInfo: '個人信息',
  ...
  transferRecovery: {
    ...
    'source': '來源路徑：',
    'target': '目標路徑：',
    'targetUnknown': '尚未產生目標路徑',
    'stage': '失敗階段：',
    'next': '下一步：',
    'attempts': '累計失敗 {count} 次',
    'skipped': '略過覆寫',
    'pauseHint':
      '此檔案的自動整理已暫停。修復原因後點選「重新整理」。也可僅刪除失敗紀錄後重新掃描；下載器任務還需移除「已整理」標籤。其他檔案不受影響。',
    'cleanupHint': '媒體已入庫。請先在下載器完成清理，再確認狀態；無需重新移動媒體檔案。',
    'cleanupConfirm': '我已在下載器完成此任務的清理',
    'resolveCleanup': '已手動清理下載器',
    'cleanupDone': '下載器清理警示已關閉。',
    'detachConfirm': '嘗試解除失效任務綁定，保留紀錄和檔案；執行中或待人工複核的任務不能解除',
    'detach': '解除失效任務綁定',
    'detachDone': '任務綁定已解除，可點選「重新整理」產生新計畫。',
    'queue': '查看整理佇列',
    'requestFailed': '操作失敗，請重新整理狀態後重試',
    'unknownReason': '未記錄具體原因，請查看整理日誌',
    'defaultAction': '檢查來源檔案、路徑映射及目標儲存後重新整理。',
    'reviewFailureHint': '判定尚未提交，任務仍待複核。請依上方原因處理；若狀態已變更，關閉視窗後重新整理佇列再檢查。',
    'batchTitle': '本次提交結果',
    'batchHint': '已接收表示背景將處理，請在整理佇列或整理紀錄查看最終結果。再次提交前請核對每項狀態，避免重複操作。',
    'states': {
      'accepted': '已接收 · 等待背景處理',
      'completed': '已完成',
      'failed': '失敗',
      'retry_wait': '背景重試中',
      'manual_review': '等待人工覆核',
      'skipped': '已略過',
    },
  },
  transferHistory: {
    ...
    status: {
      ...
      failed: '失敗',
      paused: '自動暫停',
      cleanupFailed: '下載器清理失敗',
      unknown: '未知',
    },
    failureStage: '失敗階段：{stage}',
    recoveryAction: '下一步：{action}',
    retryStatus: '已嘗試 {count}/{max} 次',
    autoPausedHint: '自動整理已暫停，請修復原因後重新整理，或刪除失敗記錄後重新掃描',
    cleanupFailedHint: '媒體已入庫，但下載器任務清理失敗，請檢查下載器任務狀態',
    cleanupResolved: '已確認下載器任務由人工清理完成',
    cleanupResolveFailed: '確認下載器清理狀態失敗，請刷新後重試',
    failureStages: {
      source_access: '來源檔案存取',
      recognition: '媒體識別',
      planning: '整理計畫',
      destination_access: '目標儲存存取',
      transfer: '檔案轉移',
      overwrite: '覆蓋策略',
      downloader_cleanup: '下載器清理',
      execution: '任務執行',
      unknown: '未知階段',
    },
    statusFilter: {
  ...
  mediaserver: {
    ...
    mediaVaultHostHint: 'MediaVault 管理面板地址（預設連接埠 7811），不是自建媒體庫的播放連接埠',
    mediaVaultApiKeyHint: 'MediaVault 管理面板->系統設定->API Key 中產生的密鑰',
  ...
  initialization: {
    ...
    password: '設定密碼',
    passwordPlaceholder: '至少 6 位，包含字母、數字或特殊字元',
    passwordHint: '建議使用同時包含字母、數字和特殊字元的強密碼',
    confirmPassword: '再次輸入密碼',
    confirmPasswordPlaceholder: '再次確認你的密碼',
    passwordMismatch: '兩次輸入的密碼不一致',
    apiKeySection: 'API 存取金鑰',
    apiKey: '產生 API Key',
    apiKeyHint: '用於腳本、外部用戶端和插件存取 API',
    generated: '已產生',
    copyApiKey: '複製 API Key',
    apiKeyCopied: 'API Key 已複製',
    apiKeyWarning: '請妥善保存，儲存後仍可在系統設定中更換',
    regenerate: '重新產生',
    saveAndContinue: '儲存並前往登入',
