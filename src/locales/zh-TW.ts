export default {
  ...
  plugin: {
    ...
    allPlugins: '所有插件',
    noRecentPlugins: '無',
    logLevelManage: '實例日誌等級',
    logLevelManageTitle: '{name} 實例日誌等級',
    logLevelScopeHint: '日誌等級按實例各管各的。這裡列出該插件的本體與全部分身，改動立即生效，無需重啟。',
    logLevelLoadFailed: '實例日誌等級加載失敗，請稍後重試',
    logLevelRefreshFailed: '操作已完成，但實例日誌等級刷新失敗，請手動重試',
    instanceHost: '本體',
    instanceClone: '分身',
    instancesEmpty: '暫無實例',
    logLevelCurrentInstance: '當前',
