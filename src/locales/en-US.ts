export default {
  ...
  theme: {
    ...
    glassUIStyle: 'Interface Style',
    glassUIStyleAdaptive: 'Adaptive',
    glassUIStyleClear: 'Clear',
    glassUIStyleHint: 'Applies to the top bar, floating bottom navigation, pop-up menus, dialogs, and FABs.',
  ...
  music: {
    ...
    selectDownloadable: 'Select downloadable',
    batchDownload: 'Batch download',
    batchDownloadConfirm: 'Download the selected {count} releases with the default downloader?',
    batchDownloadResult: 'Batch download complete: {success}/{total} succeeded',
    newestFirst: 'Newest first',
    oldestFirst: 'Oldest first',
    rematchResources: 'Match again',
    noOfficialWorks: 'No official releases to display',
    selectAlbum: 'Select album {title}',
  ...
  agentAssistant: {
    ...
    steeringPlaceholder: 'Task is running; add a message...',
    steeringQueued: 'Queued',
    steeringApplied: 'Added to context',
  ...
  subscribe: {
    ...
    execution: {
      ...
      autoResume: 'Sites are temporarily busy. Search will continue automatically; no action is needed.',
      taskResume: 'Search will continue automatically after the current task finishes; no action is needed.',
      resumeAt: 'Expected to resume at {time} (local time)',
      resumeDue: 'The expected time has arrived. Waiting to resume automatically.',
      failedHint: 'This search did not finish. Try searching again, or check your sites if the problem persists.',
      failureDetails: 'Show failure details',
      retry: 'Search again',
      checkSites: 'Check sites',
      searchSubmitted: 'Search scheduled for {name}',
      searchScheduled: 'Search scheduled for {name} and will start shortly',
      searchAlreadyRunning: '{name} is already being searched',
      batchProgress: '{processed}/{total}',
      cancel: 'Stop this search',
      ...
      state: {
        ...
        waiting_site_budget: 'Resuming later',
        preparing: 'Ready',
    ...
    maintenance: {
      ...
      searchAll: 'Search Subscriptions in This Media Type',
      searchAllConfirmTitle: 'Search Subscriptions in This Media Type?',
      searchAllConfirm:
        'The system will search the subscriptions in this media type that your account can access and contact the relevant sites. This may take some time when you have many subscriptions. Continue?',
      searchAllStarted: 'Searches for this media type are scheduled!',
      searchAllEmpty: 'There are no subscriptions to search in this media type',
      searchAllAlreadyRunning: '{count} subscriptions in this media type are already being searched',
      searchAllMixed: 'Scheduled {queued} subscriptions in this media type; {ongoing} are already in progress',
      searchAllScheduled: 'Scheduled {count} subscriptions in this media type; the system will search them in order',
  ...
  setting: {
    classification: {
      ...
      restoreDefaults: 'Restore built-in defaults',
      restoreDefaultsConfirm:
        'This replaces the current draft with the built-in classification rules and discards unpublished edits. Continue?',
      defaultsLoaded: 'Built-in classification rules restored. Validate before publishing.',
      defaultsLoadFailed: 'Failed to load the built-in classification rules',
      ...
      rollbackFailed: 'Failed to restore the classification policy',
      ...
      category: {
        ...
        fallbackBadge: 'Default',
        legacyHint:
          'This category was created during legacy migration and is kept only while rules, defaults, or directory settings reference it.',
        ...
        duplicatePath: 'Category paths must be unique within a media type',
        pathSegmentTooLong: 'Each category path segment must be at most {count} characters',
        pathTooLong: 'The category path must be at most {count} characters',
      ...
      rule: {
        ...
        limitReached: 'Up to {count} rules are allowed',
        simpleModeHint:
          'Simple mode covers media type, conditions, and the target category. Groups, sources, and labels are available in Advanced settings.',
        itemAria: 'Rule {index}: {name}',
        dragAria: 'Drag to reorder rule {name}',
        drag: 'Drag to reorder',
        priority: 'Priority {priority}',
        conditionCount: '{count} conditions',
        enableAria: 'Enable rule {name}',
        actionsAria: 'Actions for rule {name}',
        moveUp: 'Move rule {name} up',
        moveDown: 'Move rule {name} down',
        copy: 'Copy rule {name}',
        delete: 'Delete rule {name}',
        deleteConfirm: 'Delete rule “{name}”?',
        collapse: 'Collapse rule {name}',
        edit: 'Edit rule {name}',
        name: 'Rule name',
        nameAria: 'Rule name {index}',
        id: 'Rule ID',
        idAria: 'Rule ID {index}',
        invalidId:
          'Rule IDs may contain lowercase letters, numbers, dots, underscores, and hyphens, with a maximum of 128 characters.',
        duplicateId: 'Rule ID “{id}” already exists.',
        kindAria: 'Rule type {name}',
        categoryKind: 'Category',
        labelKind: 'Label',
        mediaTypes: 'Media types',
        mediaTypesAria: 'Media types for {name}',
        sources: 'Data sources',
        sourcesHint: 'Leave empty for all sources',
        sourcesAria: 'Data sources for {name}',
        conditions: 'Match conditions',
        action: 'When matched',
        categoryTarget: 'Assign to category',
        noCategoryOptions: 'No category is available for the selected media types',
        categoryTargetAria: 'Category target for {name}',
        labels: 'Output labels',
        labelsAria: 'Output labels for {name}',
        empty: 'No classification rules',
        allMediaTypes: 'All media',
        allSources: 'All sources',
        labelsSummary: 'Labels: {labels}',
        unsetLabels: 'No labels set',
        unsetCategory: 'No category set',
        disabledCategory: 'Disabled',
        newName: 'New rule {sequence}',
        copyName: '{name} copy',
      },
      condition: {
        ...
        nodeHints: {
          ...
          all: 'All: every condition must match for the rule to match.',
          any: 'Any: the rule matches when at least one condition matches.',
          not: 'Exclude: the rule does not match when the nested condition matches.',
        },
        operators: {
          equals: 'Equals',
        ...
        compatibilityField: '{label} (compatibility field)',
        valueSearchCustom: 'Search by name or code; enter a source value outside the list and press Enter.',
        valueSearch: 'Search by name or code and select a condition value.',
        valueFreeform:
          'This field has no fixed dictionary. Use the value shown in the media preview; enter multiple values one by one and press Enter.',
        supportPartial: 'Partial support',
        supportUnavailable: 'Unavailable',
        sourceScopeAll: 'No source restriction: this rule applies to all sources.',
        sourceScopeSelected:
          'Selected sources: {sources}. Multiple sources mean any one may match; source details are never merged.',
        nodeAria: 'Condition node, level {depth}',
        nodeKindAria: 'Condition node type',
        maxDepth: 'Maximum group depth reached',
        simpleGroupHint: 'This rule contains multiple conditions. Change the combination in Advanced settings.',
        noAvailableFields: 'No condition field is shared by the selected media types',
        field: 'Field',
        fieldPlaceholder: 'Search genres, years, countries, or field names',
        fieldAria: 'Condition field',
        operator: 'Operator',
        operatorAria: 'Condition operator',
        noValue: 'This operator has no value',
        rangeStart: 'Start value',
        rangeEnd: 'End value',
        valuePlaceholder: 'Search or enter a condition value',
        value: 'Condition value',
        listAria: 'Condition value list',
        booleanAria: 'Boolean condition value',
        yes: 'Yes',
        no: 'No',
        retiredHint:
          'This condition came from the legacy classification configuration and keeps its original matching behavior.',
        retiredReplacement: 'Use “{label}” for new conditions. Changing the field may change results; preview first.',
        sourceSupportAria: 'Data source field support',
        deleteChild: 'Delete child condition',
        deleteChildAria: 'Delete child condition {index}',
        addChild: 'Add condition',
        addChildAvailable: 'Add a sibling condition',
        addChildDisabled: 'No field is available, or Exclude already has a condition',
      ...
      preview: {
        ...
        search: 'Search',
        keywordRequired: 'Enter a keyword before searching',
        noSearchResults: 'No media details available for preview were found',
        searchFailed: 'Media search failed. Try again later.',
        searchResults: 'Media search results',
        selectedTitle: 'Selected media',
        clearSelection: 'Clear selected media',
        selectedSource: 'Data source',
        selectedId: 'Source number',
        ...
        unknownSource: 'Unregistered data source',
        selectionRequired: 'Search for and select a media item first',
        ...
        fieldLabels: {
          identitySource: 'Media source',
          mediaType: 'Media type',
          title: 'Title',
          year: 'Year',
          language: 'Language',
          countries: 'Countries or regions',
          genres: 'Standard genres',
          genreNames: 'Genres',
          adult: 'Adult content',
          runtime: 'Runtime',
          contentRating: 'Content rating',
          companies: 'Production companies',
          networks: 'TV networks or platforms',
          musicType: 'Music type',
          albumType: 'Album type',
          secondaryTypes: 'Additional album types',
          musicGenres: 'Music genres',
          tags: 'Music tags',
          artists: 'Artists',
          artistCountry: 'Artist country or region',
          releaseStatus: 'Release status',
          sourceExtension: 'Source-provided details',
        },
      },
      impact: {
        ...
        analyze: 'Analyze',
        scope:
          'Compares at most 200 recent records and returns up to 50 change examples. Records without retrievable details are listed separately. Analysis does not move files or modify history.',
        loading: 'Reading recent records and comparing rules…',
        ...
        overviewTitle: 'Recent Record Comparison',
        truncated: 'Only part of the recent records was compared. Records not shown cannot be assumed unchanged.',
        changeTypesTitle: 'Classification Change Types',
        categoriesTitle: 'Category Count Comparison',
        previousCategoriesAria: 'Current rule category counts',
        candidateCategoriesAria: 'Pending rule category counts',
        ...
        sampleSources: {
          ...
          recentHistory: 'Recent download and organization records (details reloaded)',
        },
        states: {
          complete: 'Complete',
        ...
        metrics: {
          ...
          skippedCount: 'Not Compared',
          unresolvedCount: 'Details Unavailable',
          truncated: 'Limited Comparison',
          sampleCount: 'Records Compared',
          ...
          partialCount: 'Still Incomplete',
          degradedCount: 'Pending Result Regressions',
        },
        columns: {
          mediaType: 'Media Type',
          source: 'Data Source',
      ...
      control: {
        ...
        conflictDescription:
          'The local operation is based on version {expected}, while the server is currently on version {current}. The local draft has been preserved. Sync the server state and rerun the analysis.',
        ...
        historyDescription:
          'After you select historical content, the server will use the current version {revision} and create a new version.',
        ...
        historyEmpty: 'No historical versions are available to restore',
        selectHistoryLegend: 'Select a historical version to restore',
        selectHistoryAria: 'Select version {revision}, with {categories} categories and {rules} rules',
        updatedAtUnknown: 'Update time unknown',
        categoryCount: '{count} categories',
        ruleCount: '{count} rules',
        rollbackNotice:
          'Restoring a version does not rewrite or delete old versions. The selected historical content is published as a new version.',
        rollbackAria: 'Publish the selected historical version as a new version',
        selectBeforeRollback: 'Select a Historical Version to Restore',
        rollbackRevision: 'Restore Version {revision} as a New Version',
        publishingStatus: 'Publishing the classification policy based on version {revision}',
        keepDraftStatus: 'Local draft preserved; reanalyzing impact',
        rollbackStatus: 'Publishing version {revision} as a new version',
        requirements: {
          ...
          impactPassed: 'Impact analysis is based on current version {revision}',
          ...
          conflictPending: 'Resolve the version conflict first',
          conflictPassed: 'No version conflict is present',
        },
      },
    },
    about: {
    ...
    system: {
      ...
      musicReleaseRegionPriorityHint:
        'Prefer these MusicBrainz release regions when structural matches are equally accurate, up to 3',
      musicReleaseScriptPriority: 'Music Script Priority',
      musicReleaseScriptPriorityHint:
        'Prefer these MusicBrainz title scripts when structural matches are equally accurate, up to 3',
      musicRegionChina: 'Mainland China',
      musicRegionTaiwan: 'Taiwan',
      musicRegionHongKong: 'Hong Kong',
      musicRegionWorldwide: 'Worldwide',
      musicRegionJapan: 'Japan',
      musicRegionUnitedStates: 'United States',
      musicRegionUnitedKingdom: 'United Kingdom',
      musicRegionSouthKorea: 'South Korea',
      musicScriptSimplified: 'Simplified Chinese',
      musicScriptTraditional: 'Traditional Chinese',
      musicScriptLatin: 'Latin',
      musicScriptJapanese: 'Japanese',
      musicScriptKorean: 'Korean',
  ...
  dialog: {
    ...
    transferQueue: {
      ...
      manualReviewStorage: 'Storage',
      manualReviewTarget: 'Target File',
      ...
      manualReviewAppliedUnavailable:
        'No target-file evidence is available to confirm completion. Choose retry instead.',
      manualReviewAppliedWarning:
        'Choose this only when the target file is complete and usable; later steps may continue, including deleting the source file.',
      manualReviewSubmitted: 'Manual review submitted',
      manualReviewSubmitFailed: 'Manual review failed. Refresh and try again.',
      manualReviewLoadFailed: 'Failed to load manual-review tasks',
      manualReviewRetry: 'Reload',
      manualReviewRetryWait: 'Retry pending',
      manualReviewRetryWaitHint:
        'Confirmed not completed. The task was returned to the background retry queue; check Transfer History for the final result.',
    },
    reorganize: {
      title: 'Organize',
      ...
      artistCollectionHint:
        'Treat the selected folder as a container: organize each first-level folder as an album, and audio files under Singles or the root as recordings. Each entry is identified and submitted independently.',
      artistCollectionRequiresDirectory: 'Artist Collection mode requires exactly one directory',
      artistCollectionEmpty: 'No album directories or audio files were found in this folder',
      artistCollectionSingles: 'Singles',
      artistCollectionProgress: 'Processing {current}/{total}: {name}',
      artistCollectionTrackCount: '{count} items',
      artistCollectionGroupCount: 'Album / singles groups',
      ...
      musicReleaseScripts: 'Title script order',
      musicReleaseScriptsHint:
        'Controls release selection; final Simplified Chinese conversion remains a separate system setting',
      musicRegionChina: 'Mainland China',
      musicRegionTaiwan: 'Taiwan',
      musicRegionHongKong: 'Hong Kong',
      musicRegionWorldwide: 'Worldwide',
      ...
      overwriteSkippedHint:
        'The target already exists and the current overwrite policy skipped this item. Adjust the policy or remove the old file, then retry.',
  ...
  plugin: {
    ...
    syncFailed: 'Plugin synchronization failed. Retry.',
    ...
    updateRestartRequired: '{name} was updated. Restart MoviePilot to finish applying dependency updates.',
    ...
    confirmThirdPartyInstall: 'Install “{name}” from {target}.',
    ...
    updateToLocal: 'Update to Local Version',
    ...
    logLevelExpiresAt: 'Expires {time}',
    logLevelEdit: 'Set level',
    logLevelSelectLabel: 'Log level',
    logLevelExpiresLabel: 'Expiry time (optional)',
    logLevelExpiresHint: 'Leave empty to never expire',
    logLevelSetSuccess: 'Log level updated',
    logLevelSetFailed: 'Failed to set: {message}',
    logLevelClear: 'Clear override',
    logLevelClearSuccess: 'Log level override cleared, falling back to the global level',
    logLevelClearFailed: 'Failed to clear: {message}',
  },
  profile: {
  ...
  transferRecovery: {
    'title': 'Transfer result and recovery',
    'source': 'Source:',
    'target': 'Destination:',
    'targetUnknown': 'Destination not planned yet',
    'stage': 'Failure stage:',
    'next': 'Next step:',
    'attempts': 'Failed {count} times',
    'skipped': 'Overwrite skipped',
    'pauseHint':
      'Automatic transfer is paused for this file. Fix the cause and select Redo. Alternatively, delete only the failed history and scan again; also remove the transferred tag from the downloader task. Other files are unaffected.',
    'cleanupHint':
      'Media has been imported. Finish cleanup in the downloader before confirming. Transferring the media again is unnecessary.',
    'cleanupConfirm': 'I have cleaned up this task in the downloader',
    'resolveCleanup': 'Confirm downloader cleanup',
    'cleanupDone': 'The downloader cleanup alert is resolved.',
    'detachConfirm':
      'Try detaching an invalid task while retaining history and files. Running tasks and tasks awaiting manual review cannot be detached.',
    'detach': 'Detach invalid task',
    'detachDone': 'Task detached. Select Redo to generate a new plan.',
    'queue': 'View transfer queue',
    'requestFailed': 'Action failed. Refresh the state and retry.',
    'unknownReason': 'No detailed reason recorded. Check the transfer logs.',
    'defaultAction': 'Check the source, path mapping and destination storage, then retry.',
    'reviewFailureHint':
      'Your decision was not submitted and the task remains under review. Follow the error above. If the state changed, close this dialog and refresh the queue.',
    'batchTitle': 'Submission results',
    'batchHint':
      'Accepted means background processing will follow. Check the transfer queue or history for the final result. Review each item before resubmitting to avoid duplicate operations.',
    'states': {
      'accepted': 'Accepted · pending',
      'completed': 'Completed',
      'failed': 'Failed',
      'retry_wait': 'Retrying in background',
  ...
  transferHistory: {
    ...
    batchDeleteFailedDetail: '{summary} ({details})',
    deleting: 'Deleting {name}...',
    ...
    status: {
      ...
      failed: 'Failed',
      paused: 'Auto-paused',
      cleanupFailed: 'Downloader cleanup failed',
      unknown: 'Unknown',
    },
    failureStage: 'Failure stage: {stage}',
    recoveryAction: 'Next step: {action}',
    retryStatus: 'Tried {count}/{max} times',
    autoPausedHint:
      'Automatic organization is paused. Fix the cause, then retry or delete the failed record and scan again.',
    cleanupFailedHint: 'Media was added, but the downloader task could not be cleaned up. Check the downloader task.',
    cleanupResolved: 'Downloader task marked as manually cleaned up',
    cleanupResolveFailed: 'Failed to confirm downloader cleanup. Refresh and try again.',
    failureStages: {
      ...
      downloader_cleanup: 'Downloader cleanup',
    ...
    actions: {
      ...
      deselectAll: 'Deselect All',
      redo: 'Reorganize',
      cleanupResolved: 'Mark Downloader Cleaned',
      delete: 'Delete',
  ...
  mediaserver: {
    ...
    mediaVaultHostHint: 'MediaVault admin panel address (default port 7811), not the self-hosted library playback port',
    mediaVaultApiKeyHint: 'API key generated in MediaVault admin panel -> System Settings -> API Key',
  ...
  initialization: {
    ...
    passwordPlaceholder: 'At least 6 characters with mixed character types',
    passwordHint: 'Use a strong password with letters, numbers, and special characters',
    confirmPassword: 'Confirm password',
    confirmPasswordPlaceholder: 'Enter the password again',
    passwordMismatch: 'The two passwords do not match',
    apiKeySection: 'API access key',
    apiKey: 'Generated API Key',
    apiKeyHint: 'Used by scripts, external clients, and plugins to access the API',
    generated: 'Generated',
    copyApiKey: 'Copy API Key',
    apiKeyCopied: 'API Key copied',
    apiKeyWarning: 'Keep it safe; you can rotate it later in System Settings',
    regenerate: 'Regenerate',
    saveAndContinue: 'Save and go to login',
